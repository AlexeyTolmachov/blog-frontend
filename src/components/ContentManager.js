...
//     e.preventDefault();
//     await axios.post('http://localhost:5000/api/news', { title, content, author: 'Author Name' });
//     setTitle('');
//     setContent('');
//   };
...
//   const [title, setTitle] = useState('');
//   const [content, setContent] = useState('');
//   const { slug } = useParams(); // предполагается, что slug передается как параметр маршрута

//   useEffect(() => {
//     if (slug) {
//       // Получаем данные новости для редактирования
...
//     e.preventDefault();
//     if (slug) {
//       // Если slug существует, обновляем существующую новость
//       await axios.put(`http://localhost:5000/api/news/${slug}`, { title, content, author: 'Author Name' });
//     } else {
//       // Если slug отсутствует, создаем новую новость
//       await axios.post('http://localhost:5000/api/news', { title, content, author: 'Author Name' });
//     }
//     setTitle('');
//     setContent('');
...
//     try {
//       await axios.put(`http://localhost:5000/api/news/${slug}`, updatedNewsData, {
//         headers: {
